...
public class AddUpdateEmployeeForm extends JDialog {
    ...
    public AddUpdateEmployeeForm(Frame owner, Employee employee) {
        super(owner, true);
        ...
        if (isUpdate) {
            idField.setText(String.valueOf(existingEmployee.id));
            idField.setEditable(false);
            nameField.setText(existingEmployee.name);
            salaryField.setText(String.valueOf(existingEmployee.salary));
            positionField.setText(existingEmployee.getClass().getSimpleName());
            departmentField.setText(existingEmployee.department.getName());
        }
